...
const initialArticles = newsArticles.map(n => ({
  id: n.id,
  title: n.title,
  category: n.category,
  excerpt: n.excerpt || "",
  content: n.content || "",
  image: n.image || "https://images.unsplash.com/photo-1500382017468-9049fed747ef?auto=format&fit=crop&q=80&w=800",
  date: n.date || new Date().toISOString(),
  author: n.author || "Admin Desa",
  readTime: n.readTime || "5 Menit"
}));
