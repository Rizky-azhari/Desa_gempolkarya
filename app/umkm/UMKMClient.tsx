...
export default function UMKMClient() {
  ...
  const [umkmList, setUmkmList] = useState<any[]>(localUmkmList);
  ...
  return (
    <div className="w-full flex flex-col min-h-screen bg-background">
      ...
      <PageHero
        ...
        description={`Mendukung pertumbuhan ekonomi mandiri warga, temukan produk makanan olahan, kerajinan bambu, dan komoditas unggulan Desa ${villageProfile.name}.`}
      ...
      <section className="py-16 bg-eggshell dark:bg-background font-sans">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader
            ...
            title="Daftar Unit Usaha Mikro Desa Gempolkarya"
