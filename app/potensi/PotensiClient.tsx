  ...
  return (
    <div className="w-full flex flex-col min-h-screen bg-background">
      ...
      <PageHero
        ...
        description={`Menjelajahi potensi agrobisnis, kelimpahan sumber daya air, industri kerajinan kriya, serta kearifan budaya Desa ${villageProfile.name}.`}
      ...
      <section className="py-16 bg-eggshell dark:bg-background font-sans">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader
            ...
            description="Kombinasi lokasi strategis dan kelimpahan air bersih melahirkan potensi unggulan desa."
          />
      ...
      <section className="py-12 bg-cardSoft dark:bg-card/20 border-t border-orinoco/10 dark:border-border/30 font-sans">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          <div className="rounded-2xl bg-primary/5 border border-primary/20 p-6 flex flex-col sm:flex-row gap-4 items-start">
            ...
            <div>
              <h4 className="text-base font-bold text-textMain dark:text-foreground">Sektor Unggulan Desa Gempolkarya</h4>
              <p className="text-sm text-textMuted dark:text-muted-foreground leading-relaxed mt-1">
                Pemerintah desa bertekad mengoptimalkan agrowisata perkebunan durian bawor dan hasil pertanian pangan dengan terus memfasilitasi perizinan legalitas UMKM serta pendampingan akses pemasaran BUMDes Gempolkarya Lestari.
              </p>
            </div>
          </div>
        </div>
