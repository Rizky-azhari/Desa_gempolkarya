        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 font-sans">
            <Card className="border border-orinoco/30 dark:border-border/60 bg-background dark:bg-card shadow-sm p-6 flex flex-col gap-4">
              ...
              <h3 className="font-heading text-lg font-bold text-textMain dark:text-foreground">Agrobisnis & Buah Lokal</h3>
              <p className="text-xs text-textMuted dark:text-muted-foreground leading-relaxed">
                Pemanfaatan lahan secara luas untuk perkebunan durian bawor unggul serta komoditas hortikultura lainnya memberikan potensi nilai jual tinggi bagi petani lokal.
              </p>
            </Card>
            ...
            <Card className="border border-orinoco/30 dark:border-border/60 bg-background dark:bg-card shadow-sm p-6 flex flex-col gap-4">
              ...
              <h3 className="font-heading text-lg font-bold text-textMain dark:text-foreground">Sistem Irigasi Lancar</h3>
              <p className="text-xs text-textMuted dark:text-muted-foreground leading-relaxed">
                Ketersediaan air bersih dan irigasi melimpah menopang kebutuhan pertanian sawah padi basah warga serta mendukung aktivitas budidaya perikanan kolam warga.
              </p>
            </Card>
      ...
      <section className="py-16 md:py-24 bg-eggshell dark:bg-background border-t border-orinoco/10 dark:border-border/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader
            ...
            description="Temukan koordinat resmi pusat pemerintahan pelayanan administrasi warga Desa Gempolkarya."
          />
          <MapEmbed height={400} />
        </div>
      </section>
