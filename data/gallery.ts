...
export const galleryList: GalleryItem[] = [
  {
    ...
    description: 'Rapat terbuka jajaran perangkat desa, BPD, RT, RW, dan tokoh masyarakat untuk menetapkan program prioritas pembangunan desa.',
  ...
  {
    id: 'g3',
    title: 'Pemberian Imunisasi Tambahan di Posyandu Melati II',
    description: 'Kader kesehatan memberikan vitamin A dan imunisasi tambahan bagi balita guna mendukung pencegahan stunting anak.',
  ...
  {
    id: 'g5',
    title: 'Pengajian Bulanan Majelis Taklim Al-Hidayah',
    description: 'Kegiatan pengajian rutin bulanan ibu-ibu PKK dan jamaah di masjid jami desa guna meningkatkan ketakwaan dan mempererat silaturahmi.',
  ...
  {
    id: 'g7',
    title: 'Turnamen Sepak Bola Kades Cup Antar Dusun',
    description: 'Aksi laga sengit pertandingan sepak bola persahabatan memperebutkan piala bergilir Kepala Desa Cup di lapangan sepak bola desa.',
  ...
  {
    id: 'g8',
    title: 'Lomba Tradisional Semarak Hari Kemerdekaan',
    description: 'Keceriaan anak-anak mengikuti lomba tradisional makan kerupuk dan balap karung dalam menyambut HUT Republik Indonesia.',
    image: 'https://images.unsplash.com/photo-1472586662442-3eec04b9dbda?auto=format&fit=crop&q=80&w=800',
    date: '2025-08-17',
    category: 'Kegiatan'
  },
  {
